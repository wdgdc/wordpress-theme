...
function bones_custom_admin_footer() {
	_e( '<span id="footer-thankyou">Developed by <a href="http://webdevelopmentgroup.com" target="_blank">Web Development Group</a></span>. Built using <a href="http://wordpress.org" target="_blank">WordPress</a>.', 'bonestheme' );
}
